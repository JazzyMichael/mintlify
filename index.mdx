...
In the most recent "Raw Day Inside YC Startup in Silicon Valley" vlog on Will Phillips' channel, ([Link with timestamp](https://youtu.be/bi5fUGudzqY?si=uQ42kax_p1Kb652I&t=463)) Han talked about the tech industry being saturated by many software engineers, but not many top performers who can actually get stuff done, and I have observed the same phenomenon.
